...
INSERT INTO `erabiltzaileak` VALUES ('73280770X','Amets','Amonarriz'),('aaa','aaa','aaa'),('ba','ba','ba'),('bla','bla','bla'),('c','a','b'),('eneko','eneko','eneko'),('portimachine','beñat','portillo'),('pringau','down','gorka');
