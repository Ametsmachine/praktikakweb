...
CREATE TABLE `atalak` (
  `id_atalak` int NOT NULL AUTO_INCREMENT,
  `atalak` varchar(45) DEFAULT NULL,
...
INSERT INTO `atalak` VALUES (1,'1.Gorputza'),(2,'2.Zubia'),(3,'3.Erreminta etxearen ardatza'),(4,'4.Mentsula'),(5,'5.Orga mahai etxea'),(6,'6.Mahaia'),(7,'7.Cnc kontrola'),(8,'8.Babesa');
